...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1460516580, '2', './data/template/2_2_common_header_home_task.tpl.php', './template/co_ilite', 'common/header_home_task')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1460516580, '2', './data/template/2_2_common_header_home_task.tpl.php', './template/co_ilite', 'common/header_home_task')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1460516580, '2', './data/template/2_2_common_header_home_task.tpl.php', './template/co_ilite', 'common/header_home_task')
;?>
