...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1461287183, '2', './data/template/2_2_common_header_forum_viewthread.tpl.php', './template/co_ilite', 'common/header_forum_viewthread')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1461287183, '2', './data/template/2_2_common_header_forum_viewthread.tpl.php', './template/co_ilite', 'common/header_forum_viewthread')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1461287183, '2', './data/template/2_2_common_header_forum_viewthread.tpl.php', './template/co_ilite', 'common/header_forum_viewthread')
;?>
...
<link href="/themes/demo/assets/images/LOGO3.ico" rel="shortcut icon" type="image/x-icon">
