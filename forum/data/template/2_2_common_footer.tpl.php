...
<div id="frt">
<p>Powered by <strong><a href="http://www.shanjing.com" target="_blank">山景</a></strong> <?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="http://license.comsenz.com/?pid=1&amp;host=<?php echo $_SERVER['HTTP_HOST'];?>" target="_blank">Licensed</a><?php } ?></p>
<!--<p>Powered by <strong><a href="http://www.shanjing.com" target="_blank">山景</a></strong> <em><?php echo $_G['setting']['version'];?></em>&lt;!&ndash;<?php if(!empty($_G['setting']['boardlicensed'])) { ?>&ndash;&gt; <a href="http://license.comsenz.com/?pid=1&amp;host=<?php echo $_SERVER['HTTP_HOST'];?>" target="_blank">Licensed</a>&lt;!&ndash;<?php } ?>&ndash;&gt;</p>-->
