...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1460618253, '2', './data/template/2_2_common_header_forum_post.tpl.php', './template/co_ilite', 'common/header_forum_post')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1460618253, '2', './data/template/2_2_common_header_forum_post.tpl.php', './template/co_ilite', 'common/header_forum_post')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1460618253, '2', './data/template/2_2_common_header_forum_post.tpl.php', './template/co_ilite', 'common/header_forum_post')
;?>
